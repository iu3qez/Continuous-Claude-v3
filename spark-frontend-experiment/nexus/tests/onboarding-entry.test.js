 ...
 *
 * Tests the onboarding.html wrapper page that provides:
 *   - NEXUS branding header
 *   - Progress bar showing current step (X of 6)
 *   - Content area for step pages
...
describe('Onboarding Entry Point', () => {
  ...
  describe('Content Area', () => {
    it('has a content area with id "step-content"', () => {
      loadOnboardingEntry();
  ...
  describe('Navigation Buttons', () => {
    ...
    it('Next button advances to step 2', () => {
      ...
      expect(stepIndicator.textContent).toContain('2 of 6');
    });
    ...
    it('Back button goes to previous step from step 2', () => {
      ...
      const stepIndicator = document.getElementById('step-indicator');
      expect(stepIndicator.textContent).toContain('1 of 6');
    });
  ...
  describe('Step Indicator', () => {
    it('shows "Step 1 of 6" text initially', () => {
      loadOnboardingEntry();
      const indicator = document.getElementById('step-indicator');
      expect(indicator).not.toBeNull();
      expect(indicator.textContent).toContain('1 of 6');
    });
  });
  ...
  // =========================================================================
  describe('Branding', () => {
    it('has NEXUS branding in the header', () => {
      loadOnboardingEntry();
      const header = document.querySelector('.onboarding-header');
      expect(header).not.toBeNull();
      expect(header.textContent).toContain('NEXUS');
    });
  });
});
